...
. Restart the the _cloud-native-spring_ application. Revisting the http://localhost:8080/actuator/health[/health] endpoint, should result in the application reporting a DOWN status. If
